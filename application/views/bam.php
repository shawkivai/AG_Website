   ...
   <div class="mainbar">
       <br>
       <br>
       <h3><u><b>Course Layout of Business Administration & Management Program [BAM-PSTU]</b></u></h3>
       <br>
  ...
  <br>
  <h3><u><b>Level-1,Semester-II</b></u></h3>
    ...
    <table class="table table-striped table-bordered bootstrap-datatable datatable" margin-left="10px" border="0" width='100%' bgcolor='#ff00ff'margin-top="10px" >
        ...
        <br>
        <h3><u><b>Level-2,Semester-I</b></u></h3>
        <br>
    ...
    <table class="table table-striped table-bordered bootstrap-datatable datatable" margin-left="10px" border="0" width='100%' bgcolor='#ff00ff'margin-top="10px" >
        ...
        <tbody>
           ...
           <br>
           <h3><u><b>Level-2,Semester-II</b></u></h3>
    ...
    <table class="table table-striped table-bordered bootstrap-datatable datatable" margin-left="10px" border="0" width='100%' bgcolor='#ff00ff'margin-top="10px" >
       ...
       <br>
       <h3><u><b>Level-3,Semester-I</b></u></h3>
    ...
    <table class="table table-striped table-bordered bootstrap-datatable datatable" margin-left="10px" border="0" width='100%' bgcolor='#ff00ff'margin-top="10px" >
       ...
       <br>
       <h3><u><b>Level-3,Semester-II</b></u></h3>
    ...
    <table class="table table-striped table-bordered bootstrap-datatable datatable" margin-left="10px" border="0" width='100%' bgcolor='#ff00ff'margin-top="10px" >
        ...
        <br>
        <h3><u><b>Level-4,Semester-I</b></u></h3>
    ...
    <table class="table table-striped table-bordered bootstrap-datatable datatable" margin-left="10px" border="0" width='100%' bgcolor='#ff00ff'margin-top="10px" >
        ...
        <tbody>
         ...
         <br>
         <h3><u><b>Level-4,Semester-II</b></u></h3>
...
<h3>Total Course Credit for Business Administration & Management program =165.00</h3>
<br>
